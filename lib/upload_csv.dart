...
class UploadCsv extends StatefulWidget {
  ...
  const UploadCsv({super.key, required this.bank});
...
class _UploadCsvState extends State<UploadCsv> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: ColorConverter.fromHex('${widget.bank['color_main']}'),
        title: Text('Rate upload'),
      ),
      body: Column(
        children: [
          Container(
            ...
            decoration:
                BoxDecoration(
                  borderRadius: BorderRadius.circular(100),
                    image: DecorationImage(image: NetworkImage('https://service.besheger.com/static/forex/bank/${widget.bank['logo']}'),fit: BoxFit.fitHeight)),
          ),
          SizedBox(height:20,),
          ElevatedButton(
            onPressed: _pickFile,
